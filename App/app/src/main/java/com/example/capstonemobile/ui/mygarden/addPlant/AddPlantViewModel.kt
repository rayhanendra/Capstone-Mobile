...
class AddPlantViewModel @ViewModelInject constructor(
    ...
    fun uploadImage(picture: MultipartBody.Part) = repository.uploadImage(picture)

    fun insertPlant(id: String, plant: PlantDetail) = repository.insertNewPlant(id,plant)
